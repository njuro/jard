...
docker run -itd --network host --env-file .env --mount 'type=volume,src=jard-usercontent,dst=/home/cnb/jard-usercontent' --name jard-server njuro/jard-server:latest &&
