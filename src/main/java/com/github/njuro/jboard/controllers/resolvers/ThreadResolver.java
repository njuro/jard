...
/**
 * Resolver for mapping thread number and board label (path variables) to respective {@link Thread} object
 *
 * @author njuro
 */
@Component
public class ThreadResolver implements PathVariableArgumentResolver {
    ...
    public Object resolveArgument(MethodParameter parameter, ModelAndViewContainer mavContainer, NativeWebRequest webRequest, WebDataBinderFactory binderFactory) {
        Long threadNumber = Long.valueOf(getPathVariable("threadNo", webRequest));
